...
export const Modals = () => {
  const sheet = useRef<Sheet.Sheet | null>(null);
    ...
    >
      ...
      <Block strongIos outlineIos>
        <p>
          ...
          `safe-area-inset-top` is more than zero (iOS fullscreen webapp or iOS
          cordova app)
        </p>
        <p>
      ...
      <Block strongIos outlineIos>
        <p>
          Sheet modal can be closed with swipe to top (for top Sheet) or bottom
          (for default Bottom sheet):
        </p>
        <p>
        ...
        <p>
          Also there is swipe-step that can be set on Sheet modal to expand it
          with swipe:
        </p>
        <p>
        ...
        <p>
          In addition to "swipe step" there is a support for position
          breakpoints (multiple steps):
        </p>
        <p>
        ...
        <PageContent>
          <Block>
            ...
            <p>
              ...
              quae expedita ea, aperiam dolores. Aut deserunt soluta alias
              magnam. Consequatur, nisi, enim.
            </p>
            <p>
              Eaque maiores ducimus, impedit unde culpa qui, explicabo
              accusamus, non vero corporis voluptatibus similique odit ab.
              Quaerat quasi consectetur quidem libero? Repudiandae adipisci vel
              voluptatum, autem libero minus dignissimos repellat.
            </p>
            <p>
              Iusto, est corrupti! Totam minus voluptas natus esse possimus
              nobis, delectus veniam expedita sapiente ut cum reprehenderit
              aliquid odio amet praesentium vero temporibus obcaecati beatae
